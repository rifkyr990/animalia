                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <h2 class="fw-bold">
                            ...
                            <p class="text-light">
                                Animalia merupakan aplikasi pengenalan hewan, aplikasi ini ditujukan untuk anak-anak maupun dewasa yang memiliki keinginnan untuk mengenali suara hewan,aplikasi ini di kembangkan oleh <strong>Rifky Ramadhan</strong> seorang <strong>Web Developer</strong>. dan aplikasi ini dikembangkan sejak tanggal 24 November 2022 kemarin.
                            </p>
                            <button class="css-button-rounded--green position-absolute" style="bottom: 100px;"><a href="{{ url('/animal') }}"
                                    class="text-decoration-none text-light">Discover Now</a></button>
                        </h2>
                    </div>
                </div>
            </div>
        ...
        <section class="team-project">
            <div class="row">
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-sm-3">
                        <div class="card bg-dark shadow-lg" style="width: 18rem;">
                            <img class="card-img-top" src="{{ asset('assets/image/dapit.jpg') }}"
                                alt="Card image cap" height="285px">
                            <div class="card-body text-center">
                    ...
                    <div class="col-sm-3">
                        <div class="card bg-dark shadow-lg" style="width: 18rem;">
                            <img class="card-img-top" src="{{ asset('assets/image/zaydan.jpg') }}"
                                alt="Card image cap">
                            <div class="card-body text-center">
